...
public class TrackerServiceImpl implements TrackerService {
    ...
    @Autowired
    TrackShareLogService trackShareLogService;
    ...
    public void trackPageView(int siteId, JsDetect detect) {
        ...
        if (site != null) {
            ...
            //写入日志
            trackShareLogService.trackerShareLog(siteId, idsubsite, detect, url, title);
        }
    }
    ...
    public void trackerUser(int siteId, JsUser user) {
        ...
        if (site != null) {
            ...
            trackShareLogService.trackerShareUser(siteId, user);
        }
    }
